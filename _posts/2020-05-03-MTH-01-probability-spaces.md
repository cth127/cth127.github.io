...
본 글은 어디까지나 본 블로그의 목적인, 배운 내용의 정리를 위한 글이고, 각 개념 및 theorm의 의미 관계를 파악하는 데 그 목적을 두며, 개별 theorm이나 lemma 대한 세세한 증명은 링크로 대체한다. 같은 맥락에서 이야기를 풀어나가는 데 크게 유용해보이지 않는 요소는 생략될 수 있으니, 좀 더 정확한 지식을 얻고 싶다면 [Durrett 선생이 온라인 배포한 교재](https://services.math.duke.edu/~rtd/PTE/PTE5_011119.pdf)를 참고하길 바란다.
