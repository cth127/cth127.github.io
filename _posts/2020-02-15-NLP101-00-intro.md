...
위의 내용을 종합해보면 결국 **그때그때 다르다**는 결론을 얻을 수 있다. 이에 본 NLP101 카테고리는 Edgar에서 제공하는 한두개의 sample text에 spaCy와 nltk를 통해 다음 task를 적용해보는 것을 목표로 한다.
...
이를 시작하기에 앞서 다음 글에서는 spaCy와 NLTK 라이브러리의 기본적인 구조를 살펴보겠다.
