...
- Lemma 1.1.7 : semi-algebra $\mathcal{S}$에 대해  $\bar{\mathcal{S}}$ = {finite disjoint unions of sets in $\mathcal{S}$}라 할 때, $\bar{\mathcal{S}}$는 algebra다. 이때 $\bar{\mathcal{S}}$를 "algebra generated by $\mathcal{S}$"라 부른다. (pf in 4p)
