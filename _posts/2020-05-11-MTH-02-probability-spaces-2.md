...
이 중 핵심이 되는 것은 1.1.9로, 앞서 다뤘던 여러 정의와 조건을 잘 정의해 나가면, 우리가 어렵지 않게 뭔가를 증명할 수 있는 유한의 세계의 개념, 즉 semi-algebra, algebra, mearsure on algebra 등의 개념을 통해, 뭔가를 증명해내기 어려운 무한의 세계의 개념, 즉 $\sigma$-algebra, measure으로 extend 시켜나갈 수 있음을 보이고 있다. 이러한 확장은 수학적인 '좋은 성질'을 보이기 위해 필수적이다. 
