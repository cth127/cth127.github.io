...
NLTK는 더 많은 토큰화 알고리즘을 제공하고, 여러 기호를 별개의 토큰으로 인식하여 후에 임베딩이나 불용어 등 단어 처리에 있어서 강점이 있고, 속도도 훨씬 빠르다. 사용이 훨씬 간편하고 직관적인 것도 NLTK의 강점이다. 한편 spaCy는 숫자나 기호 표현을 하나의 토큰으로 인식하는 강점이 있으며, 사용자가 지정한 예외를 적용할 수 있다는 강점이 있다. 물론 앞서도 언급했듯 위의 한 문장을 통해 두 라이브러리의 모든 장단점을 비교했다기엔 무리가 있다.
