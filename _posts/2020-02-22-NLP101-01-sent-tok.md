...
(88.3%), 이메일주소(@gmail.com)를 쓸 때도 사용되기도 해서 단순히 마침표로 문장을 구분하기는 어렵다. 이를 위해 [약어 사전](https://public.oed.com/how-to-use-the-oed/abbreviations/) 등의 예외사항을 binary classification 방식으로 구분하기도 한다. 본 글에서는 nltk와 spacy를 통해 sentence tokenization을 실습해보고, 각 라이브러리에서 어떤 옵션을 활용할 수 있는지를 살펴보며, 이에 어떤 알고리즘이 활용되는지를 살펴보고자 한다.
